...
def main():
    ...
    encoded_string_1 = "AATAMATAB AJTQA BAMMAQT"
    encoded_string_2 = "BFAMBA TA FATA AXTQA XAAJB AMB QATA MJAMTAB QAABQ"
    encoded_string_3 = "MQABABA AQ MATAB"
    encoded_string_4 = "QAABQ MJAMTAB AATAMATABAJJX FQAT TA FAJJ"
    encoded_string_5 = "MJAMT MAX FAQBQ AQAMF A QAMFJA QAAB"

    wordlist_paths = ['en_long_wordlist.txt']

    decode_string(encoded_string_1, wordlist_paths, "farming_top_left") 
    decode_string(encoded_string_2, wordlist_paths, "farming_top_right")
    decode_string(encoded_string_3, wordlist_paths, "farming_middle_left")
    decode_string(encoded_string_4, wordlist_paths, "farming_bottom_left")
    decode_string(encoded_string_5, wordlist_paths, "farming_bottom_right")

    encoded_name = "FAQMAMF FQAMXX"
    decode_string(encoded_name, wordlist_paths, "farming_name")
