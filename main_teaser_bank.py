...
def main():
    ...
    encoded_string_1 = "BAMJ ABBAQQ FQAM AMXTFAQA"
    encoded_string_2 = "MATA AMB AMMATA ATAMQ FQAM AMXTFAQA"

    wordlist_paths = ['en_long_wordlist.txt']

    decode_string(encoded_string_1, wordlist_paths, "bank_left") 
    decode_string(encoded_string_2, wordlist_paths, "bank_right")

    encoded_name = "BAMJAQ Q MATA"
    decode_string(encoded_name, wordlist_paths, "bank_name")
